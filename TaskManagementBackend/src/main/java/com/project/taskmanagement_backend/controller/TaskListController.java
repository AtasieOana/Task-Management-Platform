...
public class TaskListController {
    ...
    public List<TaskList> getAllTaskListsInBoard(@PathVariable Long idBoard){
    ...
    public TaskList updateTaskList(@PathVariable(name = "id") Long id,
    ...
    public void copyTaskListToAnotherBoard(@PathVariable Long idOldBoard, @PathVariable Long idNewBoard,
